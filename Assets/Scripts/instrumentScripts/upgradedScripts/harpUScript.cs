...
public class harpUScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            GameObject soundwavePlayed = (GameObject)Instantiate(soundwave, new Vector3(this.transform.position.x, (-9.8f + (currentOctave + 1) * 2), 0), this.transform.rotation);
            currentOctave -= 1;
            if (currentOctave == 1)
            {
