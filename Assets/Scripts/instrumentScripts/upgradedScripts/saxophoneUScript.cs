...
public class saxophoneUScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (ticks == frequency)
        {
            ...
            soundwavePlayed.GetComponent<soundwaveScript>().extraMoney = true;
            soundwavePlayed.GetComponent<soundwaveScript>().extraRep = true;
            ticks = 0;
