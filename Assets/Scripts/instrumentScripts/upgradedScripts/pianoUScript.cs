...
public class pianoUScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (ticks == frequency)
        {
            ...
            GameObject soundwavePlayed2 = (GameObject)Instantiate(soundwave, new Vector3(this.transform.position.x, (-9.8f + (1) * 2), 0), this.transform.rotation);
            soundwavePlayed2.GetComponent<soundwaveScript>().damage = damage;
            GameObject soundwavePlayed3 = (GameObject)Instantiate(soundwave, new Vector3(this.transform.position.x, (-9.8f + (2) * 2), 0), this.transform.rotation);
            soundwavePlayed3.GetComponent<soundwaveScript>().damage = damage;
            GameObject soundwavePlayed4 = (GameObject)Instantiate(soundwave, new Vector3(this.transform.position.x, (-9.8f + (3) * 2), 0), this.transform.rotation);
            soundwavePlayed4.GetComponent<soundwaveScript>().damage = damage;
            GameObject soundwavePlayed5 = (GameObject)Instantiate(soundwave, new Vector3(this.transform.position.x, (-9.8f + (4) * 2), 0), this.transform.rotation);
            soundwavePlayed5.GetComponent<soundwaveScript>().damage = damage;
            GameObject soundwavePlayed6 = (GameObject)Instantiate(soundwave, new Vector3(this.transform.position.x, (-9.8f + (5) * 2), 0), this.transform.rotation);
            soundwavePlayed6.GetComponent<soundwaveScript>().damage = damage;
            GameObject soundwavePlayed7 = (GameObject)Instantiate(soundwave, new Vector3(this.transform.position.x, (-9.8f + (6) * 2), 0), this.transform.rotation);
            soundwavePlayed7.GetComponent<soundwaveScript>().damage = damage;
            GameObject soundwavePlayed8 = (GameObject)Instantiate(soundwave, new Vector3(this.transform.position.x, (-9.8f + (7) * 2), 0), this.transform.rotation);
