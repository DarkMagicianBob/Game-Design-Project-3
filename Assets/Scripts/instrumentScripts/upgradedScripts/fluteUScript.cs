...
public class fluteUScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (ticks == frequency)
        {
            ...
            GameObject soundwavePlayed2 = (GameObject)Instantiate(soundwave, new Vector3(transform.position.x, transform.position.y + 2, transform.position.z), this.transform.rotation);
